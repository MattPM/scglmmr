---
title: "Pseudobulk differential expression with nested group repeated measures single cell experiment design"
output: rmarkdown::html_vignette
theme: haddock
vignette: >
  %\VignetteIndexEntry{Pseudobulk differential expression with nested group repeated measures single cell experiment design}
...
L2 = makeContrastsDream(
  ...
  data = samplemd,
  contrasts = c(
    baseline = "irae.time1_0 - irae.time0_0", # note fixef model also fit for this single time point contrast 
